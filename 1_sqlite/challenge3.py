...
engine = sqlalchemy.create_engine('sqlite:///1_sqlite/users.db', echo=True)
...
users_to_insert = [{'first_name': 'Sarah', 'last_name': 'Perry', 'email_address': 'sarah.perry@gmail.com'}, 
                   ...
                   {'first_name': 'John', 'last_name': 'Patrick', 'email_address': 'johnny.patrick@outlook.com'}, 
                   {'first_name': 'Jessica', 'last_name': 'Jones', 'email_address': 'jess.jones@hotwire.com'}, 
